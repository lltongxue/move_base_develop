...
class NavTest():  
    def __init__(self):  
        ...
        locations['p1'] = Pose(Point(-0.420, -01.451, 0.000), Quaternion(0.000, 0.000, -0.722, 0.692))  
        ...
        # locations['p2'] = Pose(Point(0.502, 1.270, 0.000), Quaternion(0.000, 0.000, 0.919, -0.392)) 
        # locations['p3'] = Pose(Point(4.557, 1.234, 0.000), Quaternion(0.000, 0.000, 0.627, 0.779)) 
        ...
        # 开始主循环，随机导航  
        while n_successes <1 and not rospy.is_shutdown():    
